			...
			<div id="solutions">
                            ...
                            <table class="genres">
                                <tr class="items_table">
                                    ...
                                    <th class="items_table">Media Type</th>
                                    <th class="items_table">Item Count</th>
                                </tr>
                                <c:forEach var="entry" items="${mediatypes}">
                                    <c:url value="/HoldOn" var="url">
                                                <c:param name="id" value="${entry.key.mediaID}"/>
                                    </c:url>
                                    <tr class="items_table">
                                        <c:choose>
                                        ...
                                        <td class="items_table">${entry.key.mediaTypeDescription}</td>
