 ...
 * @author Tony
 */
public class GetItemsByPurchaseInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<V_Items> item = new ArrayList<V_Items>();
        try {
            DatabaseController dbh = (DatabaseController) getServletContext().getAttribute("database");
            int id = new Integer(request.getParameter("id")); 
            item = dbh.getItemDetailsByPurchaseInfo(id);
            request.setAttribute("anItem", item);
